...
def init_logs(s) do
  cond do
    s.server_num == 1 ->
      s
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 1, cid: {1,1}, clientP: nil})
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 2, cid: {1,2}, clientP: nil})
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 2, cid: {1,3}, clientP: nil})
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 2, cid: {1,4}, clientP: nil})
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 2, cid: {1,5}, clientP: nil})
    s.server_num == 2 or s.server_num == 3 ->
      s
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 1, cid: {1,1}, clientP: nil})
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 2, cid: {1,2}, clientP: nil})
      |> Log.append_entry(%{cmd: { :MOVE, 100, 2, 5 }, term: 3, cid: {1,3}, clientP: nil})
    true -> s
  end
end
